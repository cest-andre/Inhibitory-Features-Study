...
from circuit_toolkit.GAN_utils import BigGAN_wrapper, upconvGAN, loadBigGAN
from circuit_toolkit.grad_RF_estim import grad_RF_estimate, gradmap2RF_square
from circuit_toolkit.layer_hook_utils import get_module_names, layername_dict, register_hook_by_module_names
from circuit_toolkit.Optimizers import CholeskyCMAES, HessCMAES, ZOHA_Sphere_lr_euclid
from circuit_toolkit.plot_utils import saveallforms, save_imgrid
#%%
...
# # args = parser.parse_args(["--net", "alexnet-eco-080", "--layer", ".classifier.Linear6", "--G", "fc6", "--optim", "CholCMA","--chans",'373','374','--steps','100',"--reps",'2'])
# args = parser.parse_args(["--net", "alexnet", "--layer", ".classifier.Linear6", "--G", "fc6", "--optim", "CholCMA","--chans",'373','374','--steps','100',"--reps",'2'])
# #%%
# """with a correct cmaes or initialization, BigGAN can match FC6 activation."""
# # Folder to save
# rootdir = r"C:\Users\alongo6\Documents\evolve_data"  # r"E:\Monkey_Data\BigGAN_Optim_Tune_tmp"
...
def resize_and_pad(imgs, corner, size):
    ...
    pad_img = torch.full(imgs.shape, 0.5, dtype=imgs.dtype, device=imgs.device)
